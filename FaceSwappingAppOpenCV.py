#https://analyticsindiamag.com/a-fun-project-on-building-a-face-swapping-application-with-opencv/ 
import cv2
import numpy as np
import dlib #pip install cmake dlib opencv-python
'''
The 68 point landmark detector is part of the dlib library. 
It assigns 68 coordinates to every human face which makes detection of specific regions like lips, eyes, nose easier.
'''
